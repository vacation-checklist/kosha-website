  ...
  const handleGeneratePdf = async () => {
    try {
      const formData = JSON.parse(
        localStorage.getItem("vacationFormData")
      ...
      alert(
        "Something went wrong while generating your checklist."
      );
    }
  };
  ...
  <FormLayout>
    ...
    <div className="confirmation-container">
      ...
      <div className="upsell-card">
        <h3>
          Looking Beyond This Trip?
        </h3>

        <p>
          Explore Kosha for organizing life events,
          family information, emergency contacts, and important records
          all in one place.
        </p>
